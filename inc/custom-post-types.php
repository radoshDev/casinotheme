...
// 			'add_new' => __('Add new slider', 'woostudy'),
// 			'add_new_item' => __('New slider', 'woostudy'),
// 			'edit_item' => __('Edit', 'woostudy'),
// 			'new_item' => __('New slider', 'woostudy'),
// 			'view_item' => __('View', 'woostudy'),
// 			'menu_item' => __('Slider', 'woostudy'),
// 			'all_items' => __('All sliders', 'woostudy')
// 		),
// 		'public' => true,
