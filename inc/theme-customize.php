...
function casinotheme_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'casinotheme_footer', array(
			...
			'priority'    => 160, // Adjust the priority to control the order
	) );

	// Add a new setting
	$wp_customize->add_setting( 'casinotheme_footer_settings', array(
			'sanitize_callback' => 'sanitize_text_field',
			'capability'        => 'edit_theme_options',
	) );

	// Add a control for the setting
	$wp_customize->add_control( 'casinotheme_footer_settings_control', array(
			...
			'settings' => 'casinotheme_footer_settings',
			'type'     => 'textarea',
	) );
}
